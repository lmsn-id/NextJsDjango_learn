    ...
    <div className="flex flex-col items-center mb-4">
      <div className="w-full flex justify-center mb-3">
        <div className="w-14 h-14 md:w-16 md:h-16 flex items-center justify-center rounded-full border-4 border-white group-hover:border-[#3a3086]">
          <FaBookBookmark className="text-2xl md:text-3xl text-white group-hover:text-[#3a3086] shadow-xl" />
        </div>
      </div>
...
const Card2 = () => (
  <div className="group flex flex-col items-center p-4 md:p-6 bg-[#3a3086] hover:bg-[#0095da] rounded-lg shadow-md w-64 h-48 md:w-72 md:h-56 mx-auto">
    <div className="flex flex-col items-center mb-4">
      <div className="w-full flex justify-center mb-3">
        <div className="w-14 h-14 md:w-16 md:h-16 flex items-center justify-center rounded-full border-4 border-white group-hover:border-[#3a3086]">
          <FaPencilAlt className="text-2xl md:text-3xl text-white group-hover:text-[#3a3086] shadow-xl" />
        </div>
      </div>
      <div className="text-center h-full">
        <h3 className="text-sm md:text-lg font-bold text-white group-hover:text-[#3a3086] mb-2">
...
const Card3 = () => (
  <div className="group flex flex-col items-center p-4 md:p-6 bg-[#3a3086] hover:bg-[#0095da] rounded-lg shadow-md w-64 h-48 md:w-72 md:h-56 mx-auto">
    <div className="flex flex-col items-center mb-4">
      <div className="w-full flex justify-center mb-3">
        <div className="w-14 h-14 md:w-16 md:h-16 flex items-center justify-center rounded-full border-4 border-white group-hover:border-[#3a3086]">
          <FiFileText className="text-2xl md:text-3xl text-white group-hover:text-[#3a3086] shadow-xl" />
        </div>
      </div>
      <div className="text-center h-full">
        <h3 className="text-sm md:text-lg font-bold text-white group-hover:text-[#3a3086] mb-2">
...
const Card4 = () => (
  <div className="group flex flex-col items-center p-4 md:p-6 bg-[#3a3086] hover:bg-[#0095da] rounded-lg shadow-md w-64 h-48 md:w-72 md:h-56 mx-auto">
    <div className="flex flex-col items-center mb-4">
      <div className="w-full flex justify-center mb-3">
        <div className="w-14 h-14 md:w-16 md:h-16 flex items-center justify-center rounded-full border-4 border-white group-hover:border-[#3a3086]">
          <FaCalendarAlt className="text-2xl md:text-3xl text-white group-hover:text-[#3a3086] shadow-xl" />
        </div>
      </div>
      <div className="text-center h-full">
        <h3 className="text-sm md:text-lg font-bold text-white group-hover:text-[#3a3086] mb-2">
